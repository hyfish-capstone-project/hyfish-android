...
data class ForumResponse(
    ...
    @field:SerializedName("data") val data: List<PostItem>,
...
data class PostItem(
    ...
    @field:SerializedName("comments") var comments: List<CommentsItem>,
...
data class CommentsItem(
    ...
    @field:SerializedName("replies") val replies: List<CommentsItem>,

    @field:SerializedName("author") val author: Author,
